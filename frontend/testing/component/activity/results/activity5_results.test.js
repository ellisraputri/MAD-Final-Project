...
import ActivityFiveResultsScreen from "@/components/activity/results/activity5-results"; // Adjust path if necessary
...
describe("ActivityFiveResultsScreen", () => {
  afterEach(() => {
    jest.clearAllMocks();
  });
  ...
  it("renders loading state correctly", () => {
    ...
    const { getByText } = render(
      <ActivityFiveResultsScreen resultId="1" onBack={jest.fn()} />
    );
