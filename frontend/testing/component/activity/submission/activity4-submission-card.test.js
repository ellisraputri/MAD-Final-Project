...
import ActivityFourSubmissionCard from "@/components/activity/submission/activity4-submission-card"; // Adjust path if necessary
...
describe("ActivityFourSubmissionCard", () => {
  ...
  it("renders correctly with all props and the vibration description", () => {
    const { getByText, getByDisplayValue } = render(
      <ActivityFourSubmissionCard {...defaultProps} />
    );
    ...
    expect(getByText("Phone moves (cm)")).toBeTruthy();
