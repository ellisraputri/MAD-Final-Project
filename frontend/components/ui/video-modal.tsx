...
export default function VideoModal({showModal, videoUri, openModal, closeModal}: VideoModalProps){
                ...
                <View style={styles.centerContent}>
                    <View style={styles.controlsContainer}>
                        ...
                        <Text style={styles.helperText}>
                            You can also adjust playback speed using the settings in native video controls.
                        </Text>
                    </View>
